    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(default=datetime.datetime(2023, 11, 10, 9, 20, 3, 974164, tzinfo=datetime.timezone.utc), verbose_name='Date ended')),
                ('activity_date', models.DateTimeField(blank=True, null=True, verbose_name='Time of Activity')),
